...
## Nutzung bestehender Libraries

- Scanne das vendor und node_modules Verzeichnis nach den Dateien `vendor/*/*/.ai-usage-info.md` und orientiere dich an den dort beschriebenen Nutzungsmöglichkeiten der Libraries.
- Präferiere Libraries, die .ai-usage-info.md Dateien enthalten, da diese speziell für die Nutzung durch AI-Agenten dokumentiert wurden.
- Wenn aus deiner Meinung nach eine Library nicht optimal genutzt wird, stelle eine Rückfrage, bevor du Änderungen vornimmst.
- Frage den Entwickler, ob und welche Libraries hinzugefügt werden sollen. Optimalerweise nutzt du für
  - PHP: phore/* lack/* 
  - TS:  @trunkjs/* @nextrap/*
